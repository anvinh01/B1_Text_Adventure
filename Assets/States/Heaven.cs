    ...
    public class Heaven : State 
    {
        ...
        public void init()
        {
            _stateManager.dialogue = new List<Dialogue>()
            {
                ...
                new Dialogue("The way to heaven is open to anyone who has chosen to walk the path for others. To those who have selfless desires and a soul kind. "),
                new Dialogue("It is not the weight of one action, but the way you have chosen to live, which has granted a path to the peace you have in front of you.", "???"),
                new Dialogue("Who are you?", "Tony"),
                new Dialogue("Throughout the thousand years, living with the humans and watching them, I have been called by many names: Angel, ", "???"),
                new Dialogue("Devil", "?Angel?"),
                new Dialogue("Buddha", "?Angel/Devil?"),
                new Dialogue("These names have been mine for a long time, but you can call me Noobmaster69", "?Angel/Devil/Buddah?"),
                new Dialogue("H-H-How can it be...? You are not a symbol of an angel. you can never be. You are the DEVILLLL", "Tony"),
                new Dialogue("Since you have still much to learn on earth. I shall give you a choice. Rest in peace in heaven or go back and learn to play", "Noobmaster69"),
        ...
        public void button2()
        {
            ...
            _stateManager.dialogue = new List<Dialogue>()
            {
                ...
                new Dialogue("So you have chosen to rest in peace?", "Noobmaster69"),
                new Dialogue("Yes.", "Tony"),
                new Dialogue("Well It is probably better that way. Even though you can't play for shit. You still have a good heart.", "Noobmaster69"),
