        ...
        public void init()
        {
            _stateManager.dialogue = new List<Dialogue>()
            {
                ...
                new Dialogue(
                    ...
                    "Mr. Anderson"),
                new Dialogue(
                    "With each word, Tonys's heart skipped a beat. Their mind raced, trying to decipher the reason behind this sudden invitation. Was it good news or perhaps a reprimand? Tony rose from their chair, following Mr. Anderson to his office, nerves tightening their grip."),
                new Dialogue(
