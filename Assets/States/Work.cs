...
namespace States
{
    public class Work : State
    {
        ...
        public void init()
        {
            ...
            _stateManager.dialogue = overtimeCount == 3
                ? new List<Dialogue>()
                {
                    ...
                    new Dialogue("Well it seems like I got a meeting with HR today again. Do you also want to attend?",
                        "Mark"),
                    new Dialogue("Tony?? Tony!! Are you there?", "???"),
                    new Dialogue("OI gotta talk with you for a moment! Do you have time?", "Boss"),
                    new Dialogue("Well it seems like you don't have time for my meeting with HR today. Good luck",
                        "Mark"),
                }
                : new List<Dialogue>()
                {
                    ...
                    new Dialogue("Well it seems like I got a meeting with HR today again. Do you also want to attend?",
                        "Mark"),
                    new Dialogue(
                        "Of course, just call me when the time comes. I'll be working on that damm bug in the meantime",
                        "Tony"),
                };
