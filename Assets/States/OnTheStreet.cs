    ...
    public class OnTheStreet : State
    {
        ...
        public void init()
        {
            _stateManager.dialogue = new List<Dialogue>()
            {
                new Dialogue(
                    ...
                    audio: _streetNormalMusic, image: _streetImage),
                new Dialogue(
                ...
                new Dialogue(
                    "Are these the streets that will define my existence? The humdrum of routine whispers doubts into my mind, questioning if I'm truly living up to my potential."),
                new Dialogue(
                ...
                new Dialogue(
                    "And amidst this sea of strangers, I wonder, do any of them feel the same existential tug I do? Are they chasing dreams or just going through the motions?"),
                new Dialogue(
                ...
                new Dialogue(
                    "They serve as a reminder that each person has their own narrative, their own battles fought silently beneath the surface. It's a humbling thought that we are all navigating our own inner worlds while existing in this shared space."),
            ...
            if (_stateManager.sleepTime >= 10)
            {
                _stateManager.dialogue = _stateManager.sleepTime == 20
                    ? new List<Dialogue>()
                    {
                        ...
                        new Dialogue(
                            "Why did I hit the snooze button? Why did I let procrastination get the best of me? These self-recriminations echo in my mind, creating a cacophony of self-doubt"),
                        new Dialogue(
            ...
            _stateManager.button2.text =
                _stateManager.sleepTime == 20 ? "Keep Running!!" : "Run to the office building";
        ...
        public void button1()
        {
            ...
            _stateManager.dialogue = new List<Dialogue>()
            {
                ...
                new Dialogue(
                    "It's a testament to what we can achieve when we come together, when we apply our skills and passions towards a common goal. I remind myself that my work, no matter how seemingly small, plays a part in this grand tapestry."),
                new Dialogue(
            ...
            else
            {
                ...
                _stateManager.dialogue = new List<Dialogue>()
                {
                    new Dialogue(
                        ...
                        audio: _despair),
                    new Dialogue(
                        " For an instant, a flicker of concern ignites within me, but it is quickly extinguished by the demands of my own urgency."),
                    new Dialogue(
                    ...
                    new Dialogue(
                        "I turn my head, my heart momentarily seizing in my chest as I witness the unthinkable—a traffic accident involving the child I had briefly noticed. The world slows to a standstill, and I am confronted with a decision, a choice that bears the weight of consequence."),
                    new Dialogue(
                    ...
                    new Dialogue(
                        "No deadline or obligation is worth sacrificing our humanity. From this moment forward, I am determined to be more present, to extend a helping hand when it is needed, and to never let the urgent overshadow the importance of compassion."),
                    new Dialogue(
        ...
        public void button3()
        {
            _stateManager.dialogue = new List<Dialogue>()
            {
                ...
                new Dialogue(
                    "In this moment, there is no room for doubt or hesitation. The instinct to protect overrides any personal fears or limitations"),
                new Dialogue(
                ...
                new Dialogue(
                    "A mix of awe, disbelief, and a profound sense of purpose washes over me, reminding me of the power of our actions in the face of adversity"),
                new Dialogue(
                ...
                new Dialogue(
                    "Panic surges through my veins, adrenaline courses through my body, and every instinct within me screams for self-preservation."),
                new Dialogue("BLACK"),
            };
            _stateManager.isTransitioning = true;
